...
public class UserController {
    ...
    @PutMapping("/profile")
    public UserProfileResponse updateUserProfile(@RequestBody CreateUserProfileRequest req) {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        if (auth == null) {
            throw new AuthenticationFailedException("auth not found");
        }
        ...
        return userProfileService.updateUserProfile(req, userResponse.getId());
    }
}
